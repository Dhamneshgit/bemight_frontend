...
<main class="main-bg">
            ...
            <div class="col-lg-4">
                ...
                <div class="col-lg-8">
                    <div class="contact-wrapper p-r z-1 mb-50" data-aos="fade-right" data-aos-delay="10" data-aos-duration="1000">
                        <div class="shape shape-one"><span><img src="assets/images/shape/cl-line.png" alt="Line Shape"></span></div>
                        <h3>Get in touch</h3>
    ...
    <section class="contact-information-section my-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="single-information-wrapper">
                        <div class="single-information-item d-flex justify-content-between mb-15" data-aos="fade-up" data-aos-duration="1400" data-aos-delay="90">
                            ...
                            <div class="content mb-20">
                                <h4>Phone</h4>
                                <p><a href="tel:+011234567890">+91 98765 43210</a></p>
                                <p><a href="tel:+011234567890">+91 01234 56789</a></p>
                            </div>
                            <div class="content mb-20">
                                <h4>Email</h4>
                                <p><a href="mailto:help@domain.com">help@bemight.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
