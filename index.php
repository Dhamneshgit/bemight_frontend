...
<link
    ...
    <main class="main-bg">
      <!--====== Start Hero Section ======-->
      <section class="hero-section" id="homeID">
        <!--=== Hero Wrapper ===-->
                ...
                <div class="row align-items-center">
                  <div class="col-lg-6">
                    ...
                    <div class="hero-content style-one mb-50">
                      ...
                      <h1>
                        Exclusive Collection of Linux automation for cotinuous delploymnet<br />
      ...
      <section class="features-section pt-130" id="aboutID">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <!--=== Features Wrapper ===-->
      ...
      <section class="aboutSection" >
        <div class="container aboutContainer">
          <div class="col-md-6 col-12 aboutImg">
            <img src="assets/images/logo/galleryImg4.png" alt="" />
          </div>
          <div class="col-md-6 col-12 aboutHead">
            <h3>About <span>BeMight</span></h3>
            <p>
              Welcome to BeMight, your ultimate destination for seamless online
              shopping! We are dedicated to bringing you a hassle-free and
              enjoyable shopping experience with a wide range of high-quality
              products at the best prices. Whether you're looking for the latest
              fashion trends, electronics, home essentials, or beauty products,
              we’ve got you covered.
            </p>
            <p>
              Our mission is to make online shopping easy, fast, and secure by
              providing a user-friendly mobile application with advanced
              features like secure payments, real-time order tracking, and
              personalized recommendations. With a commitment to customer
              satisfaction, we strive to deliver the best shopping experience
            ...
            <div class="aboutPoint">
              ...
              <li>
                <img src="assets/images/logo/check.png" alt="" />
                <div>
                  Secure & Fast Payments – Multiple payment options with
                  top-notch security.
                </div>
              </li>
              <li>
                <img src="assets/images/logo/check.png" alt="" />
                <div>
                  Exclusive Deals & Discounts – Enjoy exciting offers and
              ...
              <li>
                <img src="assets/images/logo/check.png" alt="" />
                <div>
                  24/7 Customer Support – Always here to assist you with any
                  queries or concerns.
                </div>
              </li>
            </div>
            <h4 class="mt-5">Download the Application!</h4>
            <div class="appDownload mt-4" id="galleryID">
              <a href="#"
                ><img src="assets/images/logo/playIcon.webp" alt=""
              /></a>
              <a href="#"
      ...
      <section class="gallerySection">
        <div class="container">
          <h3><span>BeMight</span> Application View</h3>
          <div class="swiper gallerySwiper">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <img src="assets/images/logo/galleryImg5.png" alt="" />
              </div>
              <div class="swiper-slide">
                <img src="assets/images/logo/galleryImg1.png" alt="" />
              </div>
              <div class="swiper-slide">
                <img src="assets/images/logo/galleryImg2.png" alt="" />
              </div>
              <div class="swiper-slide">
                <img src="assets/images/logo/galleryImg3.png" alt="" />
              </div>
              <div class="swiper-slide">
                <img src="assets/images/logo/galleryImg6.png" alt="" />
              </div>
              <div class="swiper-slide">
                <img src="assets/images/logo/galleryImg7.png" alt="" />
              </div>
      ...
      <section class="work-processing-section pt-30 pb-90" id="downloadID">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <!--=== Section Title  ===-->
            ...
            <div class="col-lg-12">
              ...
              >
                ...
                <div class="deal-content">
                  ...
                  >
                  <h2>
                    Download the App Now<span> to get best price offers!</span>
                  </h2>
