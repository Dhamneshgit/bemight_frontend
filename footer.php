                ...
                >
                  <div class="widget-content">
                    <a href="index.php" class="footer-logo"
                      ><img
                        src="assets/images/logo/bemightBlack.png"
                        alt="Brand Logo" class="footerLogo"
                    /></a>
                    <p>
                        Shop Smart, Shop Fast, Shop Anytime!
                    </p>
                    <ul class="ct-info-list mb-30">
                      <li>
                        <i class="fas fa-envelope"></i>
                        <a href="mailto:info@mydomain.com">info@bemight.com</a>
                      </li>
                      <li>
                        <i class="fas fa-phone-alt"></i>
                        <a href="mailto:info@mydomain.com">+91 98765 43210</a>
                      </li>
                    </ul>
                    ...
                    <ul class="widget-menu">
                      ...
                      <li>
                        <img
                          src="assets/images/icon/star-3.svg"
                          alt="star icon"
                        /><a href="terms-condition.php">Terms Of Condition</a>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="copyright-text">
                  <p style="text-align: center;">
                    &copy; 2025. All rights reserved by <span>BeMight</span>
                  </p>
                </div>
              </div>
          </div>
